<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="WebThongTinTaiSan.Default" %>
            ...
            <td class="style10" xml:lang="100%">
                <table class="dxflInternalEditorTable_Aqua">
                    <tr>
                        ...
                        <td align="right" class="style114" width="40%">
                            <br />
                            <dx:ASPxButton ID="btnDangNhap" runat="server" Font-Size="16px" Height="34px" 
                                onclick="btnDangNhap_Click" style="margin-left: 0px" Text="Đăng Nhập" 
                                Theme="Aqua" Width="131px">
                                <Image IconID="businessobjects_bocustomer_16x16">
                                </Image>
                            </dx:ASPxButton>
                        </td>
                        <td align="right" class="style113" width="10%">
                            &nbsp;</td>
                    </tr>
                </table>
            </td>
                                    ...
                                    <td class="style13">
                                        <dx:ASPxPageControl ID="ASPxPageControl1" runat="server" ActiveTabIndex="0" 
                                            ...
                                            <tabpages>
                                                        ...
                                                        <dx:ContentControl runat="server">
                                                            ...
                                                            <dx:ASPxGridView ID="grv_ThietBiDiKem" runat="server" 
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <dx:GridViewDataTextColumn FieldName="TSHC_Ma" 
                                                                        Name="TSHC_Ma" ShowInCustomizationForm="True" Visible="False" 
                                                                        VisibleIndex="0">
                                                                    </dx:GridViewDataTextColumn>
                                                                </Columns>
                                                            </dx:ASPxGridView>
                                                ...
                                                <dx:TabPage Text="Sửa Thông Tin Cán Bộ Sử Dụng">
                                                    <ActiveTabStyle Font-Size="16px">
                                                    </ActiveTabStyle>
                                                    <TabStyle Font-Size="14px">
                                                    </TabStyle>
                                                                        ...
                                                                        <td class="style106">
                                                                            <table class="dxflInternalEditorTable_Aqua">
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        <dx:ASPxButton ID="btnLuu" runat="server" Font-Size="16px" 
                                                                                            Text="Lưu Thay Đổi" Theme="Aqua" OnClick="btnLuu_Click">
                                                ...
                                                <dx:TabPage Text="Thêm Thông Tin Thiết Bị Đi Kèm ">
                                                    <ActiveTabStyle Font-Size="16px">
                                                    </ActiveTabStyle>
                                                    <TabStyle Font-Size="14px">
                                                    </TabStyle>
                                                    <ContentCollection>
                                                        <dx:ContentControl runat="server">
                                                            ...
                                                            <dx:ASPxGridView ID="grv_ThietBiDiKem0" runat="server" 
                                                                AutoGenerateColumns="False" EnableTheming="True" style="margin-bottom: 1px" 
                                                                Theme="Aqua" Width="100%" KeyFieldName="TSHC_Ma">
                                                                <SettingsPager PageSize="5">
                                                                </SettingsPager>
                                                                <SettingsDataSecurity AllowDelete="False" AllowEdit="False" 
                                                                    AllowInsert="False" />
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <dx:GridViewDataTextColumn Caption="Tên Tài Sản" FieldName="TSHC_TenTaiSan" 
                                                                        Name="TSHC_TenTaiSan" ShowInCustomizationForm="True" 
                                                                        VisibleIndex="3">
                                                                        <HeaderStyle Font-Bold="True" Font-Size="14px" HorizontalAlign="Center" 
                                                                            VerticalAlign="Middle" />
                                                                        <CellStyle Font-Size="14px" HorizontalAlign="Center" VerticalAlign="Middle">
                                                            ...
                                                            <table class="style9">
                                                                <tr>
                                                                    <td align="right" class="style109">
                                                                        <dx:ASPxButton ID="btnThem" runat="server" Font-Size="16px" 
                                                                            Text="Thêm" Theme="Aqua" OnClick="btnThem_Click">
                                                ...
                                                <dx:TabPage Text="Xoá Thông Tin Thiết Bị Đi Kèm">
                                                    <ActiveTabStyle Font-Size="16px">
                                                    </ActiveTabStyle>
                                                    <TabStyle Font-Size="14px">
                                                    </TabStyle>
                                                    <ContentCollection>
                                                        <dx:ContentControl runat="server">
                                                            ...
                                                            <table class="style9">
                                                                <tr>
                                                                    <td align="right" class="style109">
                                                                        <dx:ASPxButton ID="btnXoaTBDK" runat="server" Font-Size="16px" 
                                                                            OnClick="btnXoaTBDK_Click" Text="Xoá" Theme="Aqua">
                                                                    ...
                                                                    <td>
                                                                        <dx:ASPxButton ID="btnHuyXoaTBDK" runat="server" Font-Size="16px" 
                                                                            OnClick="btnHuyTBDK_Click" Text="Hủy" Theme="Aqua">
                                                                            <Image IconID="actions_cancel_16x16">
                                                                            </Image>
                                                                        </dx:ASPxButton>
                                                                    </td>
